...
public:
	...
	~ProcessFunctionStackFrame();
	//int getFuncionParameters(_DecodedInst* functionInstructions,int functionInstructionsCount, std::string baseMnemonic,
	//						std::string stackMnemonic,std::vector<ProcessFunction::FunctionParamter*>* functionParameters);
...
private:
	//StackElement* recognizeInstruction(_DecodedInst* instruction,std::string baseMnemonic,std::string stackMnemonic,
